...
WebAppBase* WebAppFactoryAGL::createWebApp(const std::string& winType, std::shared_ptr<ApplicationDescription> desc, std::shared_ptr<ShellSurface> surface)
{
    WebAppBase* app = 0;
...
WebAppBase* WebAppFactoryAGL::createWebApp(const std::string& winType, WebPageBase* page, std::shared_ptr<ApplicationDescription> desc, std::shared_ptr<ShellSurface> surface)
{
